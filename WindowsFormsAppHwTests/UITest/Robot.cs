...
namespace WindowsFormsAppHomework.Tests
{
    public class Robot
    {
        ...
        {
            SwitchTo(comboBoxName);
            var comboBox = _driver.FindElementByAccessibilityId(comboBoxName);
            comboBox.Click();
            comboBox.FindElement(By.Name(itemName)).Click();
        }
